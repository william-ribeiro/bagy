              ...
              <div style=" font-family: Calibri, Arial, Helvetica, sans-serif; font-size: 12pt; color: rgb(0, 0, 0);">
                ...
                <table cellspacing="0" cellpadding="1" style=" text-align: center; border-collapse: collapse;
                  ...
                  <tbody>
                    ...
                    <td  COLSPAN="5" style="  width: 48px; height: 25px;border-width: 1px;border-style:  solid; border-color: rgb(171, 171, 171); box-sizing: border-box; word-break: break-word; white-space: normal;">
                      <b>Valor Total</b>
                    </td>
